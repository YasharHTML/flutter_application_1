...
import 'package:myapp/models/enums/api_schema.dart';
import 'package:myapp/utils/extentions/api_level_definer.dart';
import 'package:myapp/utils/extentions/api_schema_definer.dart';
...
class EndpointBuilder {
  ...
  String build(){
    ...
    String finalUrl = this._endpointBase + this._savedParams + this._endpointParams;
    this._endpointBase = "";
    this._endpointParams = "";
    return finalUrl;
  }
